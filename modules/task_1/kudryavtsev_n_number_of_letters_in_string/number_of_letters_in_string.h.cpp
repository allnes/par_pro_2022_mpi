...
#include "../../../modules/task_1/number_of_letters_in_string/number_of_letters_in_string.h"


int my_sequentialCharCount(const std::string& procStr) {
  int countStr = 0;
...
int my_parallelCharCount(const std::string& naturalStr) {
    int size, rank;
    ...
    int loc_count = my_sequentialCharCount(localStr);
